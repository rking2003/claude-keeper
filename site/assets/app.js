    ...
    after(4200, function () {
      ...
      screens.forEach(function (sc) {
        ...
        banner.innerHTML =
          ...
          '<div class="cd-meta">at 3:00\u202FPM (America/New_York) \u00B7 then it types <b>continue</b> \u00B7 source: parsed</div>' +
      ...
      after(DEMO_WAIT_MS + 200, function () {
        setState("RESUMING");
        line('<span class="s-resuming">\u21BB</span> Limit reset \u2014 typing <span class="c">continue</span> \u23CE into the session');
      });
...
(function () {
  ...
  var REPO = "AICodeDoctor/claude-keeper";
