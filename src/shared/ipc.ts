import type { ControllerEvent, ResumeStrategy } from '@core/session-controller';
...
export const IPC = {
  ...
  sessionResumeAfter: 'session:resumeAfter',
  sessionSetAutoResume: 'session:setAutoResume',
  sessionSetReplayPrompt: 'session:setReplayPrompt',
